      ...
      <section className="grid gap-5 py-8 md:grid-cols-[1fr_19rem]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
            ...
            {startError ? (
              <p className="mt-3 text-sm font-medium text-red-700">{startError}</p>
            ) : null}
          </div>
          ...
          <div className="rounded-lg border border-red-200 bg-red-50 p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-red-800">
              Permanently deletes this tournament, all registrations, rounds,
              lobbies, participants, and scores.
            </p>
            ...
            {deleteError ? (
              <p className="mt-3 text-sm font-medium text-red-800">{deleteError}</p>
            ) : null}
          </div>
        </div>
      </section>
