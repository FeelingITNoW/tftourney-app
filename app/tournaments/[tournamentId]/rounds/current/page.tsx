    ...
    <main className="min-h-screen bg-stone-50 text-zinc-950">
      <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-6 py-6 sm:px-8 lg:px-10">
        <header className="flex items-center justify-between border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-4"><Link className="rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm font-medium text-zinc-600 shadow-sm hover:bg-zinc-50" href={tournamentPath}>Back to tournament</Link><AccountHeader returnTo={`${tournamentPath}/rounds/current`} /></div>
        </header>
        ...
        {databaseError ? (
          ...
          <>
            {!isTournamentHost ? <div className="mb-5 rounded-md border border-zinc-200 bg-white p-4 text-sm text-zinc-600">Public view: only the tournament host can enter or randomize scores.</div> : null}
                              ...
                              .map((lobby) => (
                                ...
                                >
                                  <div className="flex items-center justify-between gap-4 border-b border-zinc-200 bg-zinc-50 px-4 py-3">
                                    ...
                                    >
                                      {isTournamentHost ? "Input scores" : "View lobby"}
                                    </Link>
                                  </div>
