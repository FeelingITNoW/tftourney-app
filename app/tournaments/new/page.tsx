    ...
    <main className="min-h-screen bg-stone-50 text-zinc-950">
      <div className="mx-auto w-full max-w-[1440px] px-6 py-6 sm:px-8 lg:px-10">
        <header className="flex items-center justify-between border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-4"><Link className="text-sm font-semibold text-emerald-800 hover:text-emerald-950" href="/">Back to tournaments</Link><AccountHeader organizer={organizer} returnTo="/tournaments/new" /></div>
        </header>
