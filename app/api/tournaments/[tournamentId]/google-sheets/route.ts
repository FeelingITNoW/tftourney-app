import {
  getGoogleSheetExportStatus,
  requestGoogleSheetExport,
} from "../../../../../lib/sheets/export-api";
...
export async function GET(request: Request, context: Context) {
  ...
  try {
    ...
    return Response.json(await getGoogleSheetExportStatus(tournamentId, hostUserId));
  } catch (error) {
    return sheetErrorResponse(error, "Sheet export status could not be loaded.");
  }
}
